...
export const TermsAndConditions = () => {
  return (
    <Container className="terms-container my-5">
      <Card className="terms-card">
        <Card.Body>
          <h1 className="terms-heading text-center mb-4">Terms & Conditions</h1>
          ...
          <div className="terms-section">
            <h2>Introduction</h2>
            <p>
              Techfin Innovations Private Limited (“PPL”, “We”, “Our”, “Us”,
              “Company”) individually and collectively refer to PPL App. By
              accessing this website (https://www.pplgaming.com) & App (PPL),
              Please read this page carefully. If you do not accept the Terms
              and Conditions stated here, we would request you to exit this site
              & app. The business, any of its business divisions and / or its
              ...
              because they are binding on all users of this Website & app.
            </p>
            ...
            <p>
              ...
              without the respective organizations or entity’s written
              permission.
            </p>
            ...
            <p>
              ...
              the security of the Website, App, including, without limitation,
            ...
            <p>
              ...
              from or resulting from their use of https://www.pplgaming.com or
            ...
            <p>
              All the users who are interested in taking part at our platform
              agree to the terms and conditions given below.
            </p>
            <p>Users may accept this Agreement only:</p>
            <ol>
              <li>
                if such User is a natural Person, is of the legal age (18 years
                or more), eligibility and mental capacity to form a binding
                contract with us.
              </li>
              <li>
                if such User is a not a resident of Tamil Nadu, Andhra Pradesh,
                Telangana, Assam, Orissa, Kerala, Sikkim, Nagaland or Gujarat.
              </li>
              <li>
                if such User is a juristic Person, is lawfully existing and has
                all the authorizations, permits and allowances to enter into
                this Agreement and form a binding contract.
              </li>
              <li>
                such User is not legally barred, suspended or restricted from
                using the App.
              </li>
            </ol>

            <h2>Provision of the App</h2>
            <ol>
              <li>
                <p>
                  Section 12 of the Public Gambling Act, 1867 provides that
              ...
              <li>
                <p>
                  Users and Players must note that Games such as Battlegrounds
                  India, Garena Free Fire, COD Mobile, Ludo, etc. which are
                  available on our platform are ‘Games of Skill’, under Indian
                  law, and that we do not support, endorse or offer users ‘games
              ...
              <li>
                <p>
                  ...
                  play and take part in any events on our platform.
                </p>
              </li>
              <li>
                <p>
                  The games rules are clearly defined on this platform and all
                  the users and participants are encouraged to read, understand
                  and follow these rules to be successful in these games.
                </p>
              </li>

              <li>
                <p>
                  The games on our platform are ‘Games of Skills’, such that the
                  outcome / success in the games is directly dependent on the
                  User’s effort, performance and skills. By choosing how to
              ...
              <li>
                <p>
                  Every game will have some elements of chance, but in the form
                  of challenges, obstacles or levels that a User would be able
              ...
              <li>
                <p>
                  Since the games available on our platform can be won through
                  Users’ skills and such skills may be enhanced with practice
                  and experience, the performance of a User may improve with
                  time and practice.
                </p>
              </li>
              <li>
                <p>
                  Certain games may have pre-determined outcomes (such as in
                  Ludo Board Game), and these outcomes are achievable by Users
                  using their skills.
                </p>
              </li>
              <li>
                <p>
                  These games involves an element of financial risk and may be
